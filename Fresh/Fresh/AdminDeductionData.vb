...
Public Class AdminDeductionData


    Private Sub AdminDeductionData_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadData()
        ...
        Dim query As String = "SELECT Deduction_ID, Payroll_ID, Amount, Reason FROM Deductions WHERE Payroll_ID = @payrollID"
        ...
        Try
            ...
            dgdisplay.Columns("Deduction_ID").Visible = False
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Dim query As String = "INSERT INTO Deductions (Employee_ID, Payroll_ID, Amount, Reason, Selected) VALUES (@EmployeeID, @payrollID, @amount, @reason, True)"
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If dgdisplay.SelectedRows.Count > 0 Then
            ...
            Dim DeductionID As Integer = Convert.ToInt32(dgdisplay.SelectedRows(0).Cells("Deduction_ID").Value)
            Dim query As String = "DELETE FROM Deductions WHERE Deduction_ID = @DeductionID"
    ...
    Private Sub AdminDeductionData_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        AdminInterface.Enabled = True
